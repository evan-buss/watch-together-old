...
<div
  class="p-2 w-full flex justify-center items-center {alternate ? 'bg-gray-200 hover:bg-blue-100' : 'bg-white hover:bg-blue-100'}">
  <a href={movie.url} target="_blank" rel="noopener" class="w-2/12 truncate">
    {movie.title}
  </a>
